export const CountriesDestination = [
    {
        index: 0,
        country: 'Indonesia',
    ...
    },
    {
        ...
        destinations: [{
            ...
            src: require('../assets/Bangkok.jpg')
        },
    {
        country:'Tailandia',
        index: 1,
            ...
            src: require('../assets/ChiangMai.jpg')
        },
    {
        country:'Tailandia',
        index: 2,
            ...
            src: require('../assets/KoSamui.jpg')
        },
    {
        country:'Tailandia',
        index: 3,
